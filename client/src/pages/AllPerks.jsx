...
export default function AllPerks() {
  ...
  // ✅ Load perks from backend with search + filter params
  ...
  // ✅ Auto-search when user types or changes merchant filter (debounced)
  useEffect(() => {
  ...
  }, [searchQuery, merchantFilter]) // runs when either of them changes


  // ✅ Auto populate merchant dropdown
  useEffect(() => {
